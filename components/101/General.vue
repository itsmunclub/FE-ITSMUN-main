<template>
    <div class="w-full px-8">
      <form class="flex-col flex gap-y-3 font-montserrat text-grey" @submit.prevent="submitForm">
          ...
          <input class="w-full rounded-2xl py-3 px-4" type="text" id="University" v-model="form.University" placeholder="University" required>
          ...
          <!-- <input class="w-full rounded-2xl py-3 px-4" type="text" id="isRegist" v-model="form.isRegist" placeholder="Did you register as a new member?" required> -->
          <select class="w-full rounded-2xl py-3 px-4 text-gray-400 appearance-none" id="isRegist" v-model="form.isRegist" required>
