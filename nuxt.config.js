export default {
  ...
  plugins: [{ src: '~/plugins/helpers.js' }, { src: '~/plugins/vuelidate' }],
  ...
  auth: {
    strategies: {
      local: {
        endpoints: {
          login: {
            url: 'http://8e25-139-192-99-117.ngrok.io/login',
            method: 'post',
          },
          user: {
            url: 'http://8e25-139-192-99-117.ngrok.io/admin/',
            method: 'get',
            propertyName: false,
          },
        },
